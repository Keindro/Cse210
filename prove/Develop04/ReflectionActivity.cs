...
public class ReflectionActivity : Activity
{
    ...
    public string StartReflectionActivity(int intendedDuration)
    {
        ...
        Console.Write($"You completed this Reflection Activity {countR} times in {intendedDuration} seconds. ");
