...
public class Activity 
{
    ...
    //Constructor
    public Activity(string activityName, string activityDescription, string endingText, int intendedDuration)
    {
    ...
    //Method for the farewell message after each Activity
    ...
    //Metjhod to pause Activity when needed
