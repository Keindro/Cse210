...
class Program
{
    static void Main(string[] args)
    {
        ...
        while (userSelection != 5)
        {
            ...
            //initiate the breathing Activity
            if (userSelection == 1)
            {
                //create an object instance for the breathing Activity
                ...
                //Call the method that will ensure that the breathing Activity is initiated and completed               
                Console.WriteLine(breath1.StartBreathingActivity(duration));
            }

            //initiate the reflection Activity
            else if (userSelection == 2)
            {
                //create an object instance for the reflection activity
                ReflectionActivity reflect1 = new ReflectionActivity();
