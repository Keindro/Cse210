...
public class ListingActivity : Activity
{
    ...
    //Method to introduce and run the listing Activity
    public string StartListingActivity(int intendedDuration)
    {
        ...
        Console.Write($"You completed this Listing Activity {countL} times in {intendedDuration} seconds. ");
