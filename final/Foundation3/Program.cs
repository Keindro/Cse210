...
class Program
{
    ...
    {
        Address address = new Address("294 E 1st S, Brigham Young University", "Rexburg", "Idaho", "USA");
        ...
        Address addressR = new Address("294E 1st South, Brigham Young University", "Rexburg", "Idaho", "USA");

        Reception reception = new Reception("Devotional for Young Single Adults", "Face to face with Elder Quentin L. Cook for YSA", "August 18, 2023", "6 PM", addressR, "devotional@youngadult.com");
        Console.WriteLine();
        ...
        Address addressOG = new Address("S 2nd W & 3rd W, Porter Park", "Rexburg", "Idaho", "USA");

        OutdoorGathering outdoorGathering = new OutdoorGathering("Halloween", "Halloween Celebration", "October 31, 2023", "9 PM", addressOG, "sunny");
        Console.WriteLine();
